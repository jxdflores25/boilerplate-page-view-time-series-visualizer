...
def draw_bar_plot():
    ...
    df_bar_group=df_bar.groupby(['Year','Month'])['value'].mean().round(1)

    df_bar_group=df_bar_group.reset_index()
  
    # Draw bar plot
    legend_order=['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December']
